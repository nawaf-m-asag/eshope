    ...
    <div class="col-lg-7 col-md-6 col-12 left">
        ...
        <div class="thank-you row">
            ...
            <div class="col-lg-10 col-md-10 col-sm-8 col-8">
                ...
                <p><span class="d-inline-block">{{ __('Order number') }}:</span> <span class="d-inline-block">{{ get_order_code($order->id) }}</span> </p>
                        ...
                        <div class="row cart-item">
                            ...
                            <div class="col-4">
                                ...
                                <p style="margin-bottom: 0">
                                    <small>
                                        @if ($product->variationProductAttributes->count())
        ...
        <div class="order-customer-info">
            ...
            <p><span class="d-inline-block">{{ __('Full name') }}:</span> <span class="order-customer-info-meta">{{ $order->address->name }}</span>
            </p>
            <p><span class="d-inline-block">{{ __('Phone') }}:</span> <span
                        class="order-customer-info-meta">{{ $order->address->phone }}</span></p>
            <p><span class="d-inline-block">{{ __('Email') }}:</span> <span class="order-customer-info-meta">{{ $order->address->email }}</span>
            </p>
            <p><span class="d-inline-block">{{ __('Address') }}:</span> <span
            ...
            <p><span class="d-inline-block">{{ __('Shipping method') }}:</span> <span
                        class="order-customer-info-meta">{{ $order->shipping_method_name }}</span>
            </p>
            <p><span class="d-inline-block">{{ __('Payment method') }}:</span> <span class="order-customer-info-meta">{{ $order->payment->payment_channel->label()  }}</span>
            </p>
            <p><span class="d-inline-block">{{ __('Payment status') }}:</span> <span class="order-customer-info-meta" style="text-transform: uppercase">{!! $order->payment->status->toHtml() !!}</span>
            </p>
        </div>
        <hr/>
