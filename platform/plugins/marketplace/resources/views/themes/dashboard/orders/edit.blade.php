                                ...
                                @foreach ($order->products as $orderProduct)
                                    ...
                                    <tr>
                                        ...
                                        <td class="pl5 p-r5 min-width-200-px">
                                            <a class="text-underline hover-underline pre-line" target="_blank" href="{{ route('marketplace.vendor.products.edit', $orderProduct->product_id) }}" title="{{ $orderProduct->product_name }}">
                        ...
                        <div class="flexbox-grid-default flexbox-flex-wrap flexbox-align-items-center">
                            ...
                            @elseif ($order->payment->id)
                                ...
                                @if (!$order->payment->status || in_array($order->payment->status, [\Botble\Payment\Enums\PaymentStatusEnum::PENDING]))
                                    <div class="flexbox-auto-left">
                                        <button class="btn btn-primary btn-trigger-confirm-payment" data-target="{{ route('marketplace.vendor.orders.confirm-payment', $order->id) }}">{{ trans('plugins/ecommerce::order.confirm_payment') }}</button>
                                    </div>
                                @endif
                        ...
                        <div class="flexbox-grid-default flexbox-flex-wrap flexbox-align-items-center">
                            ...
                            @else
                                ...
                                @else
                                    ...
                                    <div class="flexbox-auto-left">
                                        <div class="item">
                                            <button class="btn btn-primary btn-trigger-shipment" data-target="{{ route('marketplace.vendor.orders.get-shipment-form', $order->id) }}">{{ trans('plugins/ecommerce::order.delivery') }}</button>
                                        </div>
                                    </div>
                                @endif
                            @endif
